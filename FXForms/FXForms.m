...
@interface FXFormMultiValueCell () <UITextFieldDelegate>
...
@implementation FXFormMultiValueCell
{
    UIView* separator1;
    UIView* separator2;
}
...
- (void)setUp
{
    ...
    separator1 = [[UIView alloc] initWithFrame:CGRectMake(100, 0, 0.5, 44)];
    separator1.backgroundColor = [UIColor lightGrayColor];
    [self.contentView addSubview:separator1];
    separator2 = [[UIView alloc] initWithFrame:CGRectMake(200, 0, 0.5, 44)];
